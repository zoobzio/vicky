// Package main is the entry point for the Go SCIP indexer service.
package main
...
func main() {
	...
	otel, err := indexers.InitOTEL(ctx, "vicky-indexer-go")
	if err != nil {
	...
	srv := indexers.NewServer(storage, &indexers.GoExecutor{}, "go")
